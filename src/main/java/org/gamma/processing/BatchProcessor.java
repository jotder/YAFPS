...
public abstract class BatchProcessor implements FileParser {
    Path outDir;
    String dims;
    String measures;
    String option;
    ...
    public BatchProcessor(YamlSourceConfigAdapter config) {
    ...
    public ProcessingResult processPhase(int batchId, String batchName, List<Path> paths) throws
            IOException {
        ...
        List<RouteInfo> routeInfList = new ArrayList<>();
...
//        System.out.printf("      %s: Processing phase completed successfully.%n", batchName);
        return new ProcessingResult(batchId, batchName, batchStart, currentThreadName, paths, filesToLoad);
    }
