...
public class SimulatedFileLoader implements FileLoader {
    ...
    @Override
    public LoadMetrics parseFile(String fileName, String targetTable) throws InterruptedException {
...
//            System.out.printf("        -> %s completed successfully on %s%n", stageName, threadName);
            return new LoadMetrics(fileName, targetTable, Status.PASS, Duration.between(loadStart, Instant.now()), threadName, null);
