...
public record SourceItem(String sourceId, boolean active, Path sourceDir, String dirFilter, String startDir,
                         String endDir,
                         String dataFileType, String fileFilter, Boolean fileBackup, Boolean deleteAfterLoad,
                         // From source dir before staging DB load
                         Path backupDir, Boolean errBackup, Path errorDir, Path outDir, // For intermediate files if any
                         Boolean useSubDirAsPartition, Integer headerLines, Integer numThreads,
